...
const mainMenuQuestions = [
    {
        ...
        name: "selection",
        choices: ["View all Employees", "View all Employees by Deparment","View all Employees by Manager", "Add an Employee","Remove an Employee","Update Employee Role","Update Emplyee Manager", "Exit"]
    },
]
